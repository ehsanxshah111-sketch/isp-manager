...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://ehsanxshah111_db_user:admin123@cluster0.9y94f1u.mongodb.net/isp_db?retryWrites=true&w=majority')
...
async function importData() {
  try {
    ...
    console.log(`✅ Added ${added} new customers`);
    console.log(`⚠️ Skipped ${skipped} existing customers`);
