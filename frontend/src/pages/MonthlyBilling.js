...
const MonthlyBilling = () => {
  ...
  const statCards = data ? [
    { label: 'Total Customers', value: data.totalCustomers, color: 'blue' },
    { label: 'Active', value: data.activeCustomers, color: 'green' },
    { label: 'Paid', value: data.paidCount, color: 'green' },
    { label: 'Unpaid', value: data.unpaidCount, color: 'red' },
    { label: 'Total Revenue (Active Only)', value: `PKR ${(data.totalRevenue || 0).toLocaleString()}`, color: 'blue' },
    { label: 'Total Dues', value: `PKR ${(data.totalDues || 0).toLocaleString()}`, color: 'red' },
    { label: 'Total Recovery', value: `PKR ${(data.totalRecovery || 0).toLocaleString()}`, color: 'orange' },
    { label: 'Total Collection', value: `PKR ${(data.totalCollected || 0).toLocaleString()}`, color: 'green' },
  ] : [];
